    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-lg md:text-xl text-center text-white/70 tracking-tight mt-5 max-w-sm mx-auto">
          Our revolutionary Car Washing tools have transformed our clients&apos;
          Luxury Cars.
        </p>
        <div className="flex overflow-hidden mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)]">
          ...
          >
            {[...images, ...images].map((image, index) => (
              <div
                key={index}
                className="border border-white/15 rounded-xl bg-[linear-gradient(to_bottom_left,rgb(140,69,255,0.3),black)] max-w-xs md:max-w-md flex-none"
              >
                <Image
                  src={image.src}
                  alt={image.alt}
